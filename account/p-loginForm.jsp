...
<input type="hidden" name="lgf" value="phone">
<script type="text/javascript">
	if("${message}"=="전화번호나 비밀번호가 틀렸습니다") {
		alert("${message}");
	}
</script>
<h2>전화번호로 로그인하기</h2>
<table>
	<tr>
		<td><input type="text" name="phone" placeholder="전화번호" style="width:500px" oninput="test(this)"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<input type="submit" value="로그인" onclick="return loginCheck2()" id="apply">
		</td>
	</tr>
</table>
</form>
